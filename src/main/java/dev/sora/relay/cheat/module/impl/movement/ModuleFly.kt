...
class ModuleFly : CheatModule("Fly", CheatCategory.MOVEMENT) {
    ...
    private var modeValue by choiceValue("Mode", arrayOf(Vanilla("Vanilla"), Mineplex(), Jetpack(), Glide(), YPort(), Motion(), Teleport()), "Vanilla")
	...
	private inner class Motion : Choice("Motion") {
		private var verticalSpeedValue by floatValue("Motion VerticalSpeed",0.2f,0.1f..3f)
		private var horizontalSpeedValue by floatValue("Motion Horizontal Speed", 1.5f, 0.1f..3f)
	...
	private inner class Teleport : Choice("Teleport"){
		private var verticalSpeedValue by floatValue("Motion VerticalSpeed",0.2f,0.1f..8f)
		private var horizontalSpeedValue by floatValue("Motion Horizontal Speed", 1.5f, 0.1f..8f)
